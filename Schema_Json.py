...
def create_bigquery_tables(project_id, dataset_id, bigquery_schema, credentials_path):
...
def main():
    ...
    credentials_path = 'path/to/your/service_account.json'  # Path to your service account JSON file
    
    # Create tables in BigQuery
    create_bigquery_tables(project_id, dataset_id, bigquery_schema, credentials_path)
